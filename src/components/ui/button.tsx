  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background text-neutral-alpha-700 hover:bg-neutral-100 hover:text-neutral-alpha-700 active:bg-neutral-200 active:text-neutral-alpha-700",
        secondary:
        ...
        ghost:
          "text-neutral-alpha-700 hover:bg-neutral-alpha-100 hover:text-neutral-alpha-700 active:bg-neutral-alpha-200 active:text-neutral-alpha-700",
        destructive:
